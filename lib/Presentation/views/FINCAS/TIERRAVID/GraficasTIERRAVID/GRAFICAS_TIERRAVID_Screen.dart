// ignore_for_file: unused_local_variable, unnecessary_null_comparison, unused_import, library_private_types_in_public_api, camel_case_types
...
class _GRAFICAS_TIERRAVID_ScreenState extends State<GRAFICAS_TIERRAVID_Screen> {
  final databaseReference = FirebaseDatabase.instance
      .ref("Empresas/TerrawaSufalyng/Result/Dato/TIERRAVID");
                        ...
                        titlesData: FlTitlesData(
                          ...
                          leftTitles: AxisTitles(
                            sideTitles: SideTitles(
                              showTitles: true,
                              reservedSize:
                                  60, // Aumentado para evitar superposición
                              interval:
                                  100, // Ajuste para que los valores no estén tan juntos
                              getTitlesWidget: (value, meta) {
                                return Padding(
                                  padding: const EdgeInsets.only(
                                      right: 8), // Evita que toque el borde
                                  child: Text(
                                    value.toStringAsFixed(
                                        0), // Sin decimales para mayor claridad
                                    style: const TextStyle(fontSize: 12),
