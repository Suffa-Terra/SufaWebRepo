...
class _Poblacion_CAMANOVILLO_Screen_State
  ...
  final DatabaseReference _CAMANOVILLOBaseRef =
...
// Define los controladores adicionales en tu clase de widget
  ...
  final GlobalKey _ResultFinalPoblacion = GlobalKey();
...
// Restablece el tutorial desde ajustes si el usuario lo quiere repetir
  ...
  void initState() {
    ...
    _initTargetsPOBLACIONCAMANOVILLO.add(
      TargetFocus(
        ...
        keyTarget: _ResultFinalPoblacion,
  ...
  Widget _buildHectSelect(
    List<String> itemsHect,
    String selectedItemHect,
    String titleHect,
    String categoryHect,
  ) {
