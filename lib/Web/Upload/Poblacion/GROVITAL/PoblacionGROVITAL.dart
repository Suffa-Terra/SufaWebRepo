...
class PoblacionGROVITALScreen extends StatefulWidget {
  const PoblacionGROVITALScreen({Key? key}) : super(key: key);

  @override
  _PoblacionGROVITALScreenState createState() => _PoblacionGROVITALScreenState();
}

class _PoblacionGROVITALScreenState extends State<PoblacionGROVITALScreen> {
