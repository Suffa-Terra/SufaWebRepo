...
class PoblacionSUFAAZAScreen extends StatefulWidget {
  const PoblacionSUFAAZAScreen({Key? key}) : super(key: key);

  @override
  _PoblacionSUFAAZAScreenState createState() => _PoblacionSUFAAZAScreenState();
}

class _PoblacionSUFAAZAScreenState extends State<PoblacionSUFAAZAScreen> {
