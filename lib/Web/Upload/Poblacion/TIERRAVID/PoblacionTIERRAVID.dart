...
class PoblacionTIERRAVIDScreen extends StatefulWidget {
  const PoblacionTIERRAVIDScreen({Key? key}) : super(key: key);

  @override
  _PoblacionTIERRAVIDScreenState createState() => _PoblacionTIERRAVIDScreenState();
}

class _PoblacionTIERRAVIDScreenState extends State<PoblacionTIERRAVIDScreen> {
